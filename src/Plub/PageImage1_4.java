...
public class PageImage1_4 extends JFrame{
	...
	public PageImage1_4() {
        ...
        add(Background);
	    능동 = new ImageIcon("C:/java/eclipse/workspaces/자바프로젝트/src/Plub/img/능동.jpg");
	    Image ndpic = 능동.getImage();
	    backgroundimg = new JPanel() {
        	public void paintComponent(Graphics g) {
        		super.paintComponent(g);
        		g.drawImage(ndpic, 0, 0, this.getWidth(), this.getHeight(), this);
        	}
        };
