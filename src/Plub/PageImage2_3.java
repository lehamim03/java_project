...
public class PageImage2_3 extends JFrame{
	static JPanel Background= new JPanel();
	static JPanel backgroundimg;
	static ImageIcon meating;
	public PageImage2_3() {
        ...
        add(Background);
        meating = new ImageIcon("C:/java/eclipse/workspaces/자바프로젝트/src/Plub/img/meating.jpg");
	    Image meatingpic = meating.getImage();
	    backgroundimg = new JPanel() {
        	public void paintComponent(Graphics g) {
        		super.paintComponent(g);
        		g.drawImage(meatingpic, 0, 0, this.getWidth(), this.getHeight(), this);
        	}
        };
