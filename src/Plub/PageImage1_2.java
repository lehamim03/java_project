...
public class PageImage1_2 extends JFrame{
	...
	public PageImage1_2() {
        ...
        add(Background);
	    flag = new ImageIcon("C:/java/eclipse/workspaces/자바프로젝트/src/Plub/img/flag.jpg");
	    Image flagpic = flag.getImage();
	    backgroundimg = new JPanel() {
        	public void paintComponent(Graphics g) {
        		super.paintComponent(g);
        		g.drawImage(flagpic, 0, 0, this.getWidth(), this.getHeight(), this);
        	}
        };
