...
public class PageImage2_1 extends JFrame{
	static JPanel Background= new JPanel();
	static JPanel backgroundimg;
	static ImageIcon wowsinal;
	public PageImage2_1() {
        ...
        add(Background);
	    wowsinal = new ImageIcon("C:/java/eclipse/workspaces/자바프로젝트/src/Plub/img/wowsinal.jpg");
	    Image wowsinalpic = wowsinal.getImage();
	    backgroundimg = new JPanel() {
        	public void paintComponent(Graphics g) {
        		super.paintComponent(g);
        		g.drawImage(wowsinalpic, 0, 0, this.getWidth(), this.getHeight(), this);
        	}
        };
