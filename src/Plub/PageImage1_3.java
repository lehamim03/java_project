...
public class PageImage1_3 extends JFrame{
	static JPanel Background= new JPanel();
	static JPanel backgroundimg;
	static ImageIcon flavor;
	public PageImage1_3() {
        ...
        add(Background);
	    flavor = new ImageIcon("C:/java/eclipse/workspaces/자바프로젝트/src/Plub/img/flavor.jpg");
	    Image flavorpic = flavor.getImage();
	    backgroundimg = new JPanel() {
        	public void paintComponent(Graphics g) {
        		super.paintComponent(g);
        		g.drawImage(flavorpic, 0, 0, this.getWidth(), this.getHeight(), this);
        	}
        };
